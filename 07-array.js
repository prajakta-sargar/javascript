...
console.log(`Array length : ${arrayNum.length}`);
    ...
    const abc = arrayNum.includes(50);
console.log(`Array includes 50 : ${abc}`);
...
const arrayY = [10, 20, 30, 40, 20, 50];
const a = array.slice(1, 4); // [30, 40]
console.log(a); // [30, 40]
...
console.log("index no 2 pasun 2 element delete kele ani tya jagi ha ele add kela66");

arrayFour.splice(2, 2, 8888, 900);
